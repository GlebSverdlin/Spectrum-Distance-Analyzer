...
class SpectralDataset(Dataset):
    def __init__(self, format, purpose):
        ...
        #TODO: add spectrawide minmax normalization
        ...
        for self.item in self.tables:
            ...
            if self.spec_max < local_max: self.spec_max = local_max
            if self.spec_min > local_min: self.spec_min = local_min
        
        j = int(len(self.spectra) / 5)
